...
def main(context=None):
    ...
    OdooObject = odoo_container(db = db, odoo_config = context['config_path'], db_server = context['db_server'], host_server = context['host_server'],version = odoo_version, is_enterprise = is_enterprise)
...
def create_db_template(db_template=None,modules=None, config_path=None,host_server = None, db_server = None, version = "16.0", is_enterprise = False, enterprise_addons_path = None):
    _logger.info(locals())
