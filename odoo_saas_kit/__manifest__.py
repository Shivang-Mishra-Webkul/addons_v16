...
#################################################################################
{
  ...
  "assets"               : {
                            'web.assets_frontend': [
                              ...
                              "/odoo_saas_kit/static/src/js/owl-carousel/owl.carousel.min.js",
                              "/odoo_saas_kit/static/src/js/owl-carousel/owl.carousel.css",
                              "/odoo_saas_kit/static/src/js/owl-carousel/owl.theme.css",
                              "/odoo_saas_kit/static/src/css/plan_page.scss",
                              "/odoo_saas_kit/static/src/js/plan_page.js",
                            ]
                           },
