...
class Website(Website):
    ...
    # @http.route(['/saas/plans/data'], type='json', auth="public", website=True)
    @http.route(['/saas/plans/data'], type='http', auth="public", website=True)
    def get_plans_data(self, **post):
        ...
        if plans:
            ...
            return request.render(
             'odoo_saas_kit.saas_pricing_plans', {
                "plans": plans,
